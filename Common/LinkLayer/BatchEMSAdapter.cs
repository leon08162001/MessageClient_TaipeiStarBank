...
namespace Common.LinkLayer
{
    ...
    public class BatchEMSAdapter : BaseEMSAdapter
    {
        ...
        public BatchEMSAdapter() : base()
        {
            ...
            this.EMSBatchMismatched += new EMSBatchMismatchedEventHandler(BatchEMSAdapter_EMSBatchMismatched);
        }
        ...
        public override void processEMSMessage(Message message)
        {
            try
            {
                ...
                if (message.PropertyExists("filename"))
                {
                    ...
                    catch (Exception ex1)
                    {
                        ...
                        RunOnEMSBatchFinished(_ErrMsg, MessageDT);
                        _IsBatchFinished = false;
                        Common.LogHelper.MoneySQLogger.LogError<BatchEMSAdapter>(ex1);
                    }
                }
                //接收文字訊息
                else
                {
                    ...
                    if (_DataType == null)
                    {
                        ...
                        Common.LogHelper.MoneySQLogger.LogInfo<BatchEMSAdapter>(_ErrMsg);
                        RunOnEMSMessageHandleFinished(_ErrMsg, null);
                        return;
                    }
            ...
            {
                Common.LogHelper.MoneySQLogger.LogError<BatchEMSAdapter>(ex);
            }
        }
        ...
        {
            Common.LogHelper.MoneySQLogger.LogInfo<BatchEMSAdapter>(e.MismatchedMessage);
        }
