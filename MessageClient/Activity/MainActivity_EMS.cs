    ...
    public class MainActivity : TabActivity
    {
        ...
        protected override async void OnCreate(Bundle bundle)
        {
            try
            {
                ...
                ChkIsFinishedEmsServiceTimer = new System.Timers.Timer();
                ChkIsFinishedEmsServiceTimer.Interval = 100;
                ...
                if ((EMSService.EMSJefferiesExcuReportPendingIntent != null && this.Intent.HasExtra("EMSJefferiesExcuReportMessage")))
                {
                    ...
                    EMSService.EMSJefferiesExcuReportPendingIntent = null;
                }
                else
                {
        ...
        protected override void OnDestroy()
        {
            ...
            _gestureListener.LeftEvent -= GestureLeft;
            _gestureListener.RightEvent -= GestureRight;
            ChkIsFinishedEmsServiceTimer.Dispose();
        ...
        void ChkIsFinishedEmsServiceTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            if (EMSService.IsFinishedEmsService)
            {
                ChkIsFinishedEmsServiceTimer.Enabled = false;
                if (EMSService.ErrorInMainApp != null && EMSService.ErrorInMainApp != "")
                {
                    RunOnUiThread(
                        () =>
                        {
                            ...
                            alert.SetMessage(EMSService.ErrorInMainApp);
