...
namespace Common.LinkLayer
{
    ...
    public class BatchMQAdapter : BaseMQAdapter
    {
        ...
        public BatchMQAdapter() : base()
        {
            ...
            this.MQBatchMismatched += new MQBatchMismatchedEventHandler(BatchMQAdapter_MQBatchMismatched);
        }
        ...
        public override void processMQMessage(IMessage message)
        {
            try
            {
                ...
                if (message.Properties.Contains("filename"))
                {
                    ...
                    catch (Exception ex1)
                    {
                        ...
                        RunOnMQBatchFinished(_ErrMsg, MessageDT);
                        _IsBatchFinished = false;
                        Common.LogHelper.MoneySQLogger.LogError<BatchMQAdapter>(ex1);
                    }
                }
                //接收文字訊息
                else
                {
                    ...
                    if (_DataType == null)
                    {
                        ...
                        Common.LogHelper.MoneySQLogger.LogInfo<BatchMQAdapter>(_ErrMsg);
                        RunOnMQMessageHandleFinished(_ErrMsg, null);
                        return;
                    }
            ...
            {
                Common.LogHelper.MoneySQLogger.LogError<BatchMQAdapter>(ex);
            }
        }
        ...
        {
            Common.LogHelper.MoneySQLogger.LogInfo<BatchMQAdapter>(e.MismatchedMessage);
        }
