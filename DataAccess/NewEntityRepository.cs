...
namespace DataAccess
{
    ...
    /// 實體化資料庫物件模型存取類別
    /// </summary>
    public class NewEntityRepository<T> where T : class, new()
    {
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        protected readonly DbContext _DbContext;
        protected readonly DbSet<T> _dbset;

        public NewEntityRepository(DbContext DbContext)
        {
        ...
        public virtual List<T> GetAll(string strSort = null)
        {
            ...
            {
                query = new List<T>();
                Common.LogHelper.MoneySQLogger.LogError<NewEntityRepository<T>>(ex);
            }
            return query;
        }
        /// <summary>
