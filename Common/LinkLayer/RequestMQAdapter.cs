...
namespace Common.LinkLayer
{
    ...
    public class RequestMQAdapter : BaseMQAdapter
    {
        ...
        public override void processMQMessage(IMessage message)
        {
            try
            {
                ...
                if (_MessageID != null && tempValues.Contains(_MessageID))
                {
                    ...
                    if (_DataType == null)
                    {
                        ...
                        Common.LogHelper.MoneySQLogger.LogInfo<RequestMQAdapter>(_ErrMsg);
            ...
            {
                Common.LogHelper.MoneySQLogger.LogError<RequestMQAdapter>(ex);
            }
        }
        ...
        {
            Common.LogHelper.MoneySQLogger.LogInfo<RequestMQAdapter>(e.MismatchedMessage);
        }
