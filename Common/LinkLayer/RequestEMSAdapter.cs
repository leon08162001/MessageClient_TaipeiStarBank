...
namespace Common.LinkLayer
{
    ...
    public class RequestEMSAdapter : BaseEMSAdapter
    {
        ...
        public RequestEMSAdapter() : base()
        {
            ...
            this.EMSResponseMismatched += new EMSResponseMismatchedEventHandler(RequestEMSAdapter_EMSResponseMismatched);
        }
        ...
        public override void processEMSMessage(Message message)
        {
            try
            {
                ...
                if (_MessageID != null && EMSMessageDictionary.Values.Contains(_MessageID))
                {
                    ...
                    if (_DataType == null)
                    {
                        ...
                        Common.LogHelper.MoneySQLogger.LogInfo<RequestEMSAdapter>(_ErrMsg);
            ...
            {
                Common.LogHelper.MoneySQLogger.LogError<RequestEMSAdapter>(ex);
            }
        }
        ...
        {
            Common.LogHelper.MoneySQLogger.LogInfo<RequestEMSAdapter>(e.MismatchedMessage);
        }
